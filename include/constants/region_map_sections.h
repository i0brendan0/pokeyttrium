...
#define MAPSEC_TOWN_1                       0xD5
#define MAPSEC_TOWN_2                       0xD6
#define MAPSEC_TOWN_3                       0xD7
#define MAPSEC_TOWN_4                       0xD8
#define MAPSEC_TOWN_5                       0xD9
#define MAPSEC_TOWN_6                       0xDA
#define MAPSEC_TOWN_7                       0xDB
#define MAPSEC_TOWN_8                       0xDC
#define MAPSEC_TOWN_9                       0xDD
#define MAPSEC_TOWN_10                      0xDE
#define MAPSEC_TOWN_11                      0xDF
#define MAPSEC_TOWN_12                      0xE0
#define MAPSEC_TOWN_13                      0xE1
#define MAPSEC_TOWN_14                      0xE2
#define MAPSEC_TOWN_15                      0xE3
#define MAPSEC_TOWN_16                      0xE4
#define MAPSEC_CEMETERY                     0xE5
#define MAPSEC_MOUNTAIN                     0xE6
#define MAPSEC_FOREST_1                     0xE7
#define MAPSEC_FOREST_2                     0xE8
#define MAPSEC_HAUNTED_HOUSE                0xE9
#define MAPSEC_DESERT_TEMPLE                0xEA
#define MAPSEC_RIVER_TEMPLE                 0xEB
#define MAPSEC_FROZEN_BEACH                 0xEC
#define MAPSEC_SANDY_BEACH                  0xED
#define MAPSEC_TWO_CITY_MINE                0xEE
...
#define MAPSEC_UNDERWATER_ROUTE_20          0xF5
