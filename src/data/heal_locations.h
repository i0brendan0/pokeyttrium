static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_THREE_CITY - 1] = {MAP_GROUP(THREE_CITY), MAP_NUM(THREE_CITY), 54, 10},
    [HEAL_LOCATION_FOUR_TOWN - 1] = {MAP_GROUP(FOUR_TOWN), MAP_NUM(FOUR_TOWN), 21, 25},
    [HEAL_LOCATION_FIVE_TOWN - 1] = {MAP_GROUP(FIVE_TOWN), MAP_NUM(FIVE_TOWN), 23, 22},
    [HEAL_LOCATION_SIX_TOWN - 1] = {MAP_GROUP(SIX_TOWN), MAP_NUM(SIX_TOWN), 10, 12},
    [HEAL_LOCATION_SEVEN_CITY - 1] = {MAP_GROUP(SEVEN_CITY), MAP_NUM(SEVEN_CITY), 17, 17},
    ...
    [HEAL_LOCATION_TEN_CITY - 1] = {MAP_GROUP(TEN_CITY), MAP_NUM(TEN_CITY), 11, 16},
    [HEAL_LOCATION_ELEVEN_CITY - 1] = {MAP_GROUP(ELEVEN_CITY), MAP_NUM(ELEVEN_CITY), 23, 17},
    ...
    [HEAL_LOCATION_SIXTEEN_TOWN - 1] = {MAP_GROUP(SIXTEEN_TOWN), MAP_NUM(SIXTEEN_TOWN), 47, 10},
};
