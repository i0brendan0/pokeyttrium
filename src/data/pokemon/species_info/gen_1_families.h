...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                {EVO_SPECIFIC_MAP, MAP_ROUTE101, SPECIES_RAICHU_ALOLA}),
    },
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 28, SPECIES_MAROWAK},
                                ...
                                {EVO_LEVEL_DUSK, 28, SPECIES_MAROWAK_ALOLA},
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_FOG, 35, SPECIES_WEEZING_GALAR},
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
                                {EVO_MOVE_TYPE, TYPE_ICE, SPECIES_MR_MIME_GALAR}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_DITTO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_ANIMON}),
    },
